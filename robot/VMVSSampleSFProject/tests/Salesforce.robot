...
Delete Records and Close Browser
    [Documentation]    This will close all open browser windows and then delete
...
Open Test Browser
    ...
    [Documentation]    Opens a test browser to the org.
    ...
...
Get Chrome Options
    ...
    Run Keyword If    '${BROWSER}' == 'headlesschrome'    Chrome Set Headless    ${options}
    Run Keyword If    '${CHROME_BINARY}' != '${empty}'    Chrome Set Binary    ${options}
